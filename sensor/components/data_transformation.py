...
class DataTransformation:
    def __init__(self, data_validation_artifact: DataValidationArtifact,
        ...
        :param data_transformation_config: Configuration for data transformation stage
        """
        try:
        ...
        try:
            ...
            preprocessor = Pipeline(
                steps=[
                    ...
                    ("RobustScaler", robust_scaler) # Keep every feature in the same scale and handle outliers
                ]
            )

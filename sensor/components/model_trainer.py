    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            if classification_train_metric.f1_score <= self.model_trainer_config.excepted_accuracy:
                raise Exception("Trained Model is not good to provide expected accuracy try to do more experiment")
            ...
            logging.info(f"Model Trainer Artifact: {model_trainer_artifact} is created successfully")
